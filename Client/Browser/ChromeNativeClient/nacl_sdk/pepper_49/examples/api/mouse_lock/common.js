...
var common = (function() {
  ...
  function handleMessage(message_event) {
    if(message_event.data == "case_start"){
      t0 = performance.now();
    }
    if(message_event.data == "case_end"){
      t1 = performance.now();
...
console.log("Testing JavaScript Fibonacci")
...
console.log("JavaScript function is done");
console.log("Testing NaCl Fibonacci");
